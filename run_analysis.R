...
variables$V2 <- gsub("tBody","TimeBody",variables$V2)
variables$V2 <- gsub("tGravity","TimeGravity",variables$V2)
variables$V2 <- gsub("fBody","FrequencyBody",variables$V2)
variables$V2 <- gsub("fGravity","FrequencyGravity",variables$V2)
variables$V2 <- gsub("-mean-","Mean",variables$V2)
variables$V2 <- gsub("-std-","StdDev",variables$V2)
variables$V2 <- gsub("Acc", "Acceleration", variables$V2)
variables$V2 <- gsub("-mean","Mean",variables$V2)
variables$V2 <- gsub("-std","StdDev",variables$V2)
